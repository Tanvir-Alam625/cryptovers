  ...
  return (
    <header className="flex h-16 w-full items-center bg-white px-6 drop-shadow-sm dark:bg-slate-800">
      ...
      <div className={'ms-6 hidden w-72 sm:inline-block'}>
        <SearchBox className="border-transparent bg-slate-100 focus-within:border-primary-500 dark:border-transparent dark:bg-slate-700 dark:focus-within:border-primary-500" />
      </div>
